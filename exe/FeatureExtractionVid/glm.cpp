  ...
  while (group) {
    ...
    for (i = 0; i < group->numtriangles; i++) {
	  ...
	  if (mode & GLM_TEXTURE)
		  ...
		  glTexCoord2f(model->texcoords[2 * T(group->triangles[i]).tindices[0]], 
			 - model->texcoords[2 * T(group->triangles[i]).tindices[0]+Y]);
	/*  printf("%f %f\n",
		  model->texcoords[2 * T(group->triangles[i]).tindices[0]],
		 - model->texcoords[2 * T(group->triangles[i]).tindices[0] + Y]);*/
      ...
      if (mode & GLM_TEXTURE)
        //glTexCoord2fv(&model->texcoords[2 * T(group->triangles[i]).tindices[1]]);
		  glTexCoord2f(model->texcoords[2 * T(group->triangles[i]).tindices[1]],
      ...
      if (mode & GLM_TEXTURE)
        //glTexCoord2fv(&model->texcoords[2 * T(group->triangles[i]).tindices[2]]);
		  glTexCoord2f(model->texcoords[2 * T(group->triangles[i]).tindices[2]],
